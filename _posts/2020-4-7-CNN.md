...
+\left(\frac{\partial L}{\partial V}\right)_{1,0}w_{0,2}
\end{align} 
$$
...
previously, I calculated a couple of elements of the matrix and foundd some patterns to determine the general solution.
